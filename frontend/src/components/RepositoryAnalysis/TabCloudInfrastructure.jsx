      ...
      <div className="tab-pane-content">
        ...
        <div className="insights-panel">
          ...
          <div className="insights-panel-text">
            <strong>Not yet analyzed.</strong> Cloud platform selection, Terraform, and CI/CD pipeline generation are handled by upcoming agents, not yet part of this analysis.
          </div>
        </div>
      </div>
    );
